    ...
    def register_callbacks(self, dashapp):
        ...
        def display_value(value):
            ...
            try:
                ...
                citation = html.P([html.H5("Citation:"), html.I("No information available.")])
            ...
            benchmark_info = ds.data.contributed_values[ds.data.default_benchmark.lower()].theory_level
            return (
