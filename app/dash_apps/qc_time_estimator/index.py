...
class QCTimeEstimatorApp(DashAppBase):
    ...
    layout = html.Div(
        [
            ...
            ### Header
            dbc.Row([dbc.Col([html.H3("QC Execution Time Estimator")])],
                    className='mb-5'),

            dbc.Alert("Please enter required fields with valid values.",
                id='error-msg', color="danger", is_open=False, dismissable=True,),
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col([
                        dcc.Input(id="threads", value=1, size=25),
                    ]),
                ],
                className='mb-2',
            ),
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col([
                        dcc.Dropdown(id="cpu-launch-year", options=[{"label": k, "value": k} for k in range(2020, 2000, -1)]),
                    ]),
                ],
                className='mb-5',
            ),
            ...
            dbc.Row(
                [
                    dbc.Col([
                        html.Button('Submit', id='submit', className='float-right btn-primary'),
                        ],
                    ),
                ],
                className='mb-5',
    ...
    def register_callbacks(self, dashapp):
        ...
        def update_output(n_clicks, molecule, method, basis_set, driver,
                          restricted, threads, cpu_clock_speed, cpu_launch_year):
